...
document.getElementById("autocorr").setAttribute("src", "static/media/graphs/autocorr/"+content1+content2+"autocorr.html")
document.getElementById("lpc").setAttribute("src", "static/media/graphs/lpc/"+content1+content2+"lpc.html")
