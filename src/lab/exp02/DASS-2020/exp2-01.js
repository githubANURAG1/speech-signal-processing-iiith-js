        ...
        for(var itr = 0;itr < content1ph.length -1;itr++){
            ...
            for(var i = 0;i < 6;i++){
                ...
                if(i == 0){
                    ...
                    td.innerHTML = '<button type="button" style="width:120px;" onclick="wavesurfer.play('+begin+','+end+')" class="btn btn-info" value = '+fields[0]+'>'+fields[0]+'</button>'
                }
                ...
                if(i == 3 || i == 4 || i == 5){
                    ...
                    if(i == 3){
                        var option = "Select-Extn-type:None:Voiced:Unvoiced:Unvoiced-Unasp-Plosive:Unvoiced-Asp-Plosive:Voiced-Unasp-Plosive:Voiced-Asp-Plosive";
                        select_fields = option.split(':');
                        
                        select_option = '<select id="Extn_type" onchange=verify(this,"'+fields[i]+'")>';
                        
                        for(var field_itr = 0; field_itr < select_fields.length;field_itr++){
                            select_option += '<option value='+select_fields[field_itr]+' name='+field_itr+'>'+select_fields[field_itr]+'</option>';
                        }
                    ...
                    if(i == 4){
                        var manner_list = "Select-manner:None:Stop:Nasal:Semivowel:Short-Vowel:Long-Vowel:Diphthong:Fricative";
